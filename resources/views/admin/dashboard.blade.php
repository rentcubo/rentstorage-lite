    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="{{route('admin.users_index')}}" class="small-box-footer">{{tr('more_info')}}<i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{route('admin.providers_index')}}" class="small-box-footer">{{tr('more_info')}}<i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="{{route('admin.bookings_index')}}" class="small-box-footer">{{tr('more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="{{route('admin.bookings_payment')}}" class="small-box-footer">{{tr('more_info')}}<i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
    </div>
                        ...
                        @if(count($recent_users) > 0) 
                            ...
                            @foreach($recent_users as $user_details)
                                ...
                                <li>
                                    ...
                                    <a class="users-list-name" href="{{ route('admin.users_view' , ['user_id' => $user_details->id] ) }}" target="_blank">{{ $user_details->name }}</a>
                            ...
                            <div class="box-footer text-center">
                                <a href="{{ route('admin.users_index') }}" class="btn btn-info uppercase">{{ tr('view_all') }}</a>
                            </div>  
                        @else
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <ul class="products-list product-list-in-box">
                            ...
                            @if($v< 5) 
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('admin.providers_view' , ['provider_id' => $provider_details->id] ) }}" class="product-title">{{ substr($provider_details->title, 0,50) }}
                        ...
                        <div class="box-footer text-center">
                            <a href="{{ route('admin.providers_index') }}" class="btn btn-info uppercase">{{ tr('view_all') }}</a>
                        </div>
                    @else
