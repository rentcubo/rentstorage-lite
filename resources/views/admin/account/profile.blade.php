    ...
    <div class="col-md-5 grid-margin stretch-card">
        ...
        <div class="box">
            <div class="box-body">
                ...
                <form class="forms-sample" role="form" method="POST" action="{{route('admin.profile_save')}}" enctype="multipart/form-data">
            ...
            <div class="col-12 grid-margin">
                <div class="box">
                    <div class="box-body">
                        ...
                        <form  action="{{route('admin.change_password')}}" method="POST" enctype="multipart/form-data" role="form">
