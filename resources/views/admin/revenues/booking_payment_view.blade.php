                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td class="pr-0 text-right"><a href="{{ route('admin.users_view')}}">{{  $booking_payment_details->users->name ?? tr('user_not_avail')}}</a></td>
                                        </tr>

                                        <tr>
                                          <td class="pl-0">{{ tr('space') }}</td>
                                          <td class="pr-0 text-right"><a href="{{ route('admin.spaces_view')}}">{{  $booking_payment_details->spaces->name ?? tr('space_not_avail')}}</a></td>
                                        </tr>

                                        <tr>
                                          <td class="pl-0">{{ tr('provider') }}</td>
                                          <td class="pr-0 text-right"><a href="{{ route('admin.providers_view')}}">{{ $booking_payment_details->providers->name ?? tr('provider_not_avail')}}</a></td>
                                        </tr>
                                        <tr>
