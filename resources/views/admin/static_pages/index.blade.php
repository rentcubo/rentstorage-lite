            ...
            <div class="box box-primary">
                ...
                <div class="box-header bg-card-header">
                    ...
                    <h4 class="">{{tr('static_pages')}}
                        <button class="btn btn-secondary pull-right"><a  href="{{route('admin.static_pages_create')}}">
                            ...
                            <tbody>
                                ...
                                @foreach($static_pages as $i => $static_page_details)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.static_pages_view' , ['static_page_id'=> $static_page_details->id] )}}"> {{$static_page_details->title}}</a>
                                        </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('admin.static_pages_view', ['static_page_id' => $static_page_details->id] ) }}">
                                                    {{tr('view')}}
                                                </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('admin.static_pages_edit', ['static_page_id' => $static_page_details->id] ) }}">
                                                        {{tr('edit')}}
                                                    </a>
                                                </li>
                                                <li class="divider"></li>
                                                <li>
                                                    ...
                                                    onclick="return confirm(&quot;{{tr('static_page_delete_confirmation' , $static_page_details->title)}}&quot;);" href="{{ route('admin.static_pages_delete', ['static_page_id' => $static_page_details->id] ) }}" >
                                                        {{ tr('delete') }}
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('admin.static_pages_status', ['static_page_id' =>  $static_page_details->id] ) }}" 
