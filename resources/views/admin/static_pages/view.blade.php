...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><i class="fa fa-book"></i>
        <a href="{{ route('admin.static_pages_index') }}">&nbsp{{tr('static_pages')}}</a>
    </li>
                            ...
                            <div class="custom-card">
                                ...
                                @if(Setting::get('is_demo_control_enabled') == NO)
                                    <div class="col-md-4 col-lg-4">
                                        ...
                                        <a href="{{ route('admin.static_pages_edit', ['static_page_id'=> $static_page_details->id] ) }}" class="btn btn-primary btn-block">{{tr('edit')}}</a>
                                        
                                    </div>                              

                                    <div class="col-md-4 col-lg-4">
                                        <a onclick="return confirm(&quot;{{tr('static_page_delete_confirmation' , $static_page_details->title)}}&quot;);" href="{{ route('admin.static_pages_delete', ['static_page_id'=> $static_page_details->id] ) }}" class="btn btn-danger btn-block">
                                            {{ tr('delete') }}
                                        </a>
                                ...
                                @if($static_page_details->status == APPROVED)
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        ...
                                        <a class="btn btn-warning btn-block" href="{{ route('admin.static_pages_status', ['static_page_id'=> $static_page_details->id] ) }}" onclick="return confirm(&quot;{{ $static_page_details->title }}-{{tr('static_page_decline_confirmation' , $static_page_details->title)}}&quot;);">
                                ...
                                @else
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                         <a class="btn btn-success btn-block" href="{{ route('admin.static_pages_status', ['static_page_id'=> $static_page_details->id] ) }}">
                                            {{tr('approve')}}
                                        </a>
                                    </div>
