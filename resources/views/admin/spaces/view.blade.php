                            ...
                            <div class="card-group">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="view overlay">
                                        ...
                                        <img class="image" src="{{$space_details->picture ?: asset('space-placeholder.jpg')}}">
                                        <a href="#!">
                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-0 text-right">
                                                        <div><a href="{{route('admin.providers_view',['provider_id'=> $space_details->provider_id])}}">{{ $space_details->providers ? $space_details->providers->name : "-" }}</a></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a class="btn btn-primary" href="{{ route('admin.spaces_edit', ['space_id' => $space_details->id])}}">{{tr('edit')}}</a>

                                                        <a class="btn btn-danger" href="{{route('admin.spaces_delete', ['space_id' => $space_details->id])}}" onclick="return confirm(&quot;{{tr('admin_space_delete_confirmation' , $space_details->name)}}&quot;);">{{tr('delete')}}</a> 
                                                        @if($space_details->admin_status == SPACE_APPROVED)

                                                            <a class="btn btn-danger" href="{{ route('admin.spaces_status', ['space_id' => $space_details->id]) }}" onclick="return confirm(&quot;{{$space_details->name}} - {{tr('admin_space_decline_confirmation')}}&quot;);">
                                                                {{ tr('decline') }} 
                                                            </a> 
                                                        @else

                                                            <a class="btn btn-success" href="{{ route('admin.spaces_status', ['space_id' => $space_details->id]) }}">
                                                                {{ tr('approve') }} 
                                                            </a> 
                                                        @endif
                                                    </td>
