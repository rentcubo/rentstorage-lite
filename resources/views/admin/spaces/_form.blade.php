            ...
            <div class="box box-primary">
                ...
                <div class="box-header bg-card-header">
                    ...
                    <h4 class="">
                        ...
                        <a  href="{{route('admin.spaces_index')}}">
                ...
                <div class="box-body">
                    ...
                    <form class="forms-sample" action="{{ route('admin.spaces_save') }}" method="POST" enctype="multipart/form-data" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="space_types">{{ tr('space_type') }}<span class="admin-required">*</span>  </label>
                                <select class="form-control select2" name="space_type" required>
                                    <option value="">{{tr('select')}}</option>
