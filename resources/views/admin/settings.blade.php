                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        <div id="setting" class="tab-pane fade in active">
                            <form id="site_settings_save" action="{{ route('admin.settings_save') }}" method="POST" enctype="multipart/form-data" role="form">
                        ...
                        <div id="email_setting" class="tab-pane fade">
                            <form action="{{ route('admin.common-settings_save') }}" method="POST" enctype="multipart/form-data" role="form">
                                @csrf       
                                <div class="box-body">
                        ...
                        <div id="revenue_setting" class="tab-pane fade">
                            <form action="{{ (Setting::get('admin_delete_control') == YES ) ? '#' : route('admin.settings_save') }}" method="POST" enctype="multipart/form-data" role="form">
                                @csrf
                                <div class="box-body">
