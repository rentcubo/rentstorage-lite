                ...
                <div class="auth-form-light text-left p-5">
                    ...
                    <form class="forms-sample" method="post" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" id="password" name="password" placeholder="{{tr('password')}}" minlength="6" value= "{{ old('password') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4 font-weight-light">
                            <a href="{{ route('password.request') }}" class="text-primary">{{ tr('forgot_password') }} ?</a>
                        </div>
                        <div class="text-center mt-4 font-weight-light">
                            {{ tr('new_account') }} 
                            <a href="{{ route('register') }}" class="text-primary">{{ tr('register') }}</a>
                        </div>
