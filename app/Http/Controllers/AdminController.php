...
{   
    ...
    public function users_edit(Request $request) {
        ...
        try {
            ...
            return redirect()->route('admin.users_index')->with('flash_error' , $error);
        }
    ...
    public function users_save(Request $request) {
        ...
        try {
            ...
            if($user_details->save()) {
                ...
                return redirect()->route('admin.users_view', ['user_id' => $user_details->id])->with('flash_success', $message);
    ...
    public function users_delete(Request $request) {
        ...
        try {
            ...
            if($user_details->delete()) {
                ...
                return redirect()->route('admin.users_index')->with('flash_success',tr('user_deleted_success'));   
    ...
    public function providers_save(Request $request) {
       ...
       try {
            ...
            $providers_details->mobile =  $request->mobile ?: $providers_details->mobile;

            $providers_details->description = $request->description ?: $providers_details->description;
            ...
            if($providers_details->save()) {
                ...
                return redirect()->route('admin.providers_view', ['provider_id' => $providers_details->id])->with('flash_success', $message);
    ...
    public function providers_delete(Request $request) {
        ...
        try {
            ...
            if($provider_details->delete()) {
                ...
                return redirect()->route('admin.providers_index')->with('flash_success',tr('provider_delete_success')); 
            } 
            ...
            return redirect()->route('admin.providers_index')->with('flash_error', $error);
    ...
    **/
    ...
    public function spaces_create() {
        ...
        $space_types = [PRIVATE_SPACE, SHARED_SPACE];
    ...
    public function spaces_save(Request $request) {
        ...
        try {
            ...
            if($space_details->id) {
                ...
                $space_details->picture = asset('placeholder.jpg');

                $space_details->admin_status = SPACE_APPROVED;
            ...
            if($space_details->save()) {
                ...
                return redirect()->route('admin.spaces_view', ['space_id' => $space_details->id])->with('flash_success', $message);
    ...
    public function spaces_delete(Request $request) {
        try {
            ...
            if($space_details->delete()) {
                ...
                return redirect()->route('admin.spaces_index')->with('flash_success',tr('space_delete_success')); 
            } 
            ...
            return redirect()->route('admin.spaces_index')->with('flash_error', $error);
    ...
    **/
    ...
    public function static_pages_edit(Request $request) {
        ...
        try {
            ...
            return redirect()->route('admin.static_pages_index')->with('flash_error' , $error);
    ...
    public function static_pages_save(Request $request) {
        ...
        try {
            ...
            if($static_page_details->save()) {
                ...
                return redirect()->route('admin.static_pages_view', ['static_page_id' => $static_page_details->id] )->with('flash_success', $message);
    ...
    public function static_pages_delete(Request $request) {
        ...
        try {
            ...
            if($static_page_details->delete()) {
                ...
                return redirect()->route('admin.static_pages_index')->with('flash_success',tr('static_page_deleted_success')); 
    ...
    public function static_pages_view(Request $request) {
        ...
        if(!$static_page_details) {
            ...
            return redirect()->route('admin.static_pages_index')->with('flash_error',tr('static_page_not_found'));
