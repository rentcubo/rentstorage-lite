...
if(!defined('CANCELLED')) define('CANCELLED', 0);


if(!defined('BOOKING_CREATED')) define('BOOKING_CREATED', 3);
if(!defined('BOOKING_INITIATE')) define('BOOKING_INITIATE', 2);
...
if(!defined('PUBLISH')) define('PUBLISH', 1);
if(!defined('UNPUBLISH')) define('UNPUBLISH', 0);
